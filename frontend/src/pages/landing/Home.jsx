  ...
  <div className="max-w-7xl mx-auto px-6 text-center">
    ...
    <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
      ...
      <div className="bg-white p-4 rounded-xl shadow-md hover:shadow-lg transition">
        ...
        <div>
        <h3 className="text-xl font-semibold mb-2">Kids Cut</h3>
        <p className="text-gray-600 max-w-3xl mx-auto mb-10">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { name: "Ian", feedback: "Amazing experience! Highly recommend.", img: "/images/client-ian.jpg" },
              { name: "Ssenyonjo", feedback: "Friendly staff and excellent service.", img: "/images/client-ssenyonjo.jpg" },
              { name: "Rachel", feedback: "Best salon experience I've had!", img: "/images/client-rachel.jpg" },
              { name: "Sharifa", feedback: "Beautiful results, very professional.", img: "/images/client-sharifa.jpg" },
            ].map((c, idx) => (
      ...
      <section className="py-16 bg-gray-100 flex flex-col justify-center align-center">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <img
            ...
            alt="Digital booking"
            className="w-full md:w-[90%] h-80 object-cover center rounded-xl mb-6 shadow-md"
          />
